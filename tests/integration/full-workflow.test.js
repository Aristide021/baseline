...
describe('Full Workflow Integration Tests', () => {
  ...
  describe('JavaScript Feature Detection and Policy Evaluation', () => {
    it('should detect and evaluate modern JavaScript features', async () => {
      ...
      expect(apiFeatures.size).toBeGreaterThan(2); // Mock has 3 features
      ...
      expect(fallbackFeatures.size).toBeGreaterThan(2); // Mock web-features has 3 features
  ...
  describe('Performance and Caching', () => {
    it('should cache baseline data efficiently', async () => {
      ...
      expect(apiFeatures2.size).toBeGreaterThan(2); // Mock features
      ...
      expect(fallbackFeatures2.size).toBeGreaterThan(2); // Mock web-features has 3 features
    });
